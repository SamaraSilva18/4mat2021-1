...
// 1) A palavra function foi substituída pelo sinal => de´pos do parâmetro
...
// parênteses em voltada deles retornam
...
function megasena() {
    ...
    // Math.random() -> retorna um número aleatório entre 0 (inclusive) e 1 (inclusive)
...
// 6 números de um jogo de megasena
...
const megasena2 = () => Math.floor(Mathrandom() * 60 * 1)
